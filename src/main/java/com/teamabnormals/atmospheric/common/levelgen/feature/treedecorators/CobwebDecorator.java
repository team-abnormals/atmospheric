...
public class CobwebDecorator extends TreeDecorator {
	public static final MapCodec<CobwebDecorator> CODEC = Codec.floatRange(0.0F, 1.0F).fieldOf("probability").xmap(CobwebDecorator::new, (decorator) -> decorator.probability);
