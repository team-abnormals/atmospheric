...
public class AtmosphericBoatTypes {
	public static final BoatloadBoatType ROSEWOOD = BoatloadBoatType.register(BoatloadBoatType.create(Atmospheric.location("rosewood"), () -> AtmosphericBlocks.ROSEWOOD_PLANKS.get().asItem(), () -> AtmosphericItems.ROSEWOOD_BOAT.get(), () -> AtmosphericItems.ROSEWOOD_CHEST_BOAT.get(), () -> AtmosphericItems.ROSEWOOD_FURNACE_BOAT.get(), () -> AtmosphericItems.LARGE_ROSEWOOD_BOAT.get()));
	public static final BoatloadBoatType MORADO = BoatloadBoatType.register(BoatloadBoatType.create(Atmospheric.location("morado"), () -> AtmosphericBlocks.MORADO_PLANKS.get().asItem(), () -> AtmosphericItems.MORADO_BOAT.get(), () -> AtmosphericItems.MORADO_CHEST_BOAT.get(), () -> AtmosphericItems.MORADO_FURNACE_BOAT.get(), () -> AtmosphericItems.LARGE_MORADO_BOAT.get()));
	public static final BoatloadBoatType YUCCA = BoatloadBoatType.register(BoatloadBoatType.create(Atmospheric.location("yucca"), () -> AtmosphericBlocks.YUCCA_PLANKS.get().asItem(), () -> AtmosphericItems.YUCCA_BOAT.get(), () -> AtmosphericItems.YUCCA_CHEST_BOAT.get(), () -> AtmosphericItems.YUCCA_FURNACE_BOAT.get(), () -> AtmosphericItems.LARGE_YUCCA_BOAT.get()));
	public static final BoatloadBoatType KOUSA = BoatloadBoatType.register(BoatloadBoatType.create(Atmospheric.location("kousa"), () -> AtmosphericBlocks.KOUSA_PLANKS.get().asItem(), () -> AtmosphericItems.KOUSA_BOAT.get(), () -> AtmosphericItems.KOUSA_CHEST_BOAT.get(), () -> AtmosphericItems.KOUSA_FURNACE_BOAT.get(), () -> AtmosphericItems.LARGE_KOUSA_BOAT.get()));
	public static final BoatloadBoatType ASPEN = BoatloadBoatType.register(BoatloadBoatType.create(Atmospheric.location("aspen"), () -> AtmosphericBlocks.ASPEN_PLANKS.get().asItem(), () -> AtmosphericItems.ASPEN_BOAT.get(), () -> AtmosphericItems.ASPEN_CHEST_BOAT.get(), () -> AtmosphericItems.ASPEN_FURNACE_BOAT.get(), () -> AtmosphericItems.LARGE_ASPEN_BOAT.get()));
	public static final BoatloadBoatType LAUREL = BoatloadBoatType.register(BoatloadBoatType.create(Atmospheric.location("laurel"), () -> AtmosphericBlocks.LAUREL_PLANKS.get().asItem(), () -> AtmosphericItems.LAUREL_BOAT.get(), () -> AtmosphericItems.LAUREL_CHEST_BOAT.get(), () -> AtmosphericItems.LAUREL_FURNACE_BOAT.get(), () -> AtmosphericItems.LARGE_LAUREL_BOAT.get()));
	public static final BoatloadBoatType GRIMWOOD = BoatloadBoatType.register(BoatloadBoatType.create(Atmospheric.location("grimwood"), () -> AtmosphericBlocks.GRIMWOOD_PLANKS.get().asItem(), () -> AtmosphericItems.GRIMWOOD_BOAT.get(), () -> AtmosphericItems.GRIMWOOD_CHEST_BOAT.get(), () -> AtmosphericItems.GRIMWOOD_FURNACE_BOAT.get(), () -> AtmosphericItems.LARGE_GRIMWOOD_BOAT.get()));
