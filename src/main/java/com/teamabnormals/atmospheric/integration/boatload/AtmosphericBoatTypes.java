...
public class AtmosphericBoatTypes {
	public static final BoatloadBoatType ROSEWOOD = BoatloadBoatType.register(BoatloadBoatType.create(new ResourceLocation(Atmospheric.MOD_ID, "rosewood"), () -> AtmosphericBlocks.ROSEWOOD_PLANKS.get().asItem(), () -> AtmosphericItems.ROSEWOOD_BOAT.getFirst().get(), () -> AtmosphericItems.ROSEWOOD_BOAT.getSecond().get(), () -> AtmosphericItems.ROSEWOOD_FURNACE_BOAT.get(), () -> AtmosphericItems.LARGE_ROSEWOOD_BOAT.get()));
	public static final BoatloadBoatType MORADO = BoatloadBoatType.register(BoatloadBoatType.create(new ResourceLocation(Atmospheric.MOD_ID, "morado"), () -> AtmosphericBlocks.MORADO_PLANKS.get().asItem(), () -> AtmosphericItems.MORADO_BOAT.getFirst().get(), () -> AtmosphericItems.MORADO_BOAT.getSecond().get(), () -> AtmosphericItems.MORADO_FURNACE_BOAT.get(), () -> AtmosphericItems.LARGE_MORADO_BOAT.get()));
	public static final BoatloadBoatType YUCCA = BoatloadBoatType.register(BoatloadBoatType.create(new ResourceLocation(Atmospheric.MOD_ID, "yucca"), () -> AtmosphericBlocks.YUCCA_PLANKS.get().asItem(), () -> AtmosphericItems.YUCCA_BOAT.getFirst().get(), () -> AtmosphericItems.YUCCA_BOAT.getSecond().get(), () -> AtmosphericItems.YUCCA_FURNACE_BOAT.get(), () -> AtmosphericItems.LARGE_YUCCA_BOAT.get()));
	public static final BoatloadBoatType KOUSA = BoatloadBoatType.register(BoatloadBoatType.create(new ResourceLocation(Atmospheric.MOD_ID, "kousa"), () -> AtmosphericBlocks.KOUSA_PLANKS.get().asItem(), () -> AtmosphericItems.KOUSA_BOAT.getFirst().get(), () -> AtmosphericItems.KOUSA_BOAT.getSecond().get(), () -> AtmosphericItems.KOUSA_FURNACE_BOAT.get(), () -> AtmosphericItems.LARGE_KOUSA_BOAT.get()));
	public static final BoatloadBoatType ASPEN = BoatloadBoatType.register(BoatloadBoatType.create(new ResourceLocation(Atmospheric.MOD_ID, "aspen"), () -> AtmosphericBlocks.ASPEN_PLANKS.get().asItem(), () -> AtmosphericItems.ASPEN_BOAT.getFirst().get(), () -> AtmosphericItems.ASPEN_BOAT.getSecond().get(), () -> AtmosphericItems.ASPEN_FURNACE_BOAT.get(), () -> AtmosphericItems.LARGE_ASPEN_BOAT.get()));
	public static final BoatloadBoatType LAUREL = BoatloadBoatType.register(BoatloadBoatType.create(new ResourceLocation(Atmospheric.MOD_ID, "laurel"), () -> AtmosphericBlocks.LAUREL_PLANKS.get().asItem(), () -> AtmosphericItems.LAUREL_BOAT.getFirst().get(), () -> AtmosphericItems.LAUREL_BOAT.getSecond().get(), () -> AtmosphericItems.LAUREL_FURNACE_BOAT.get(), () -> AtmosphericItems.LARGE_LAUREL_BOAT.get()));
	public static final BoatloadBoatType GRIMWOOD = BoatloadBoatType.register(BoatloadBoatType.create(new ResourceLocation(Atmospheric.MOD_ID, "grimwood"), () -> AtmosphericBlocks.GRIMWOOD_PLANKS.get().asItem(), () -> AtmosphericItems.GRIMWOOD_BOAT.getFirst().get(), () -> AtmosphericItems.GRIMWOOD_BOAT.getSecond().get(), () -> AtmosphericItems.GRIMWOOD_FURNACE_BOAT.get(), () -> AtmosphericItems.LARGE_GRIMWOOD_BOAT.get()));
