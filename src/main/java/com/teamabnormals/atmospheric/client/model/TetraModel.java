package com.teamabnormals.atmospheric.client.model;// Made with Blockbench 4.12.2
...
public class TetraModel<T extends Tetra> extends HierarchicalModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		part.addOrReplaceChild("tail", CubeListBuilder.create().texOffs(3, 10).addBox(0.0F, -3.0F, 2.0F, 0.0F, 2.0F, 2.0F), PartPose.offset(0.0F, 24.0F, 0.0F));
