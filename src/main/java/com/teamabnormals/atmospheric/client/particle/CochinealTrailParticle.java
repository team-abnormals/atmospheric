...
@OnlyIn(Dist.CLIENT)
public class CochinealTrailParticle extends TextureSheetParticle {

	public CochinealTrailParticle(ClientLevel world, double posX, double posY, double posZ, double motionX, double motionY, double motionZ) {
	...
	public static class Provider implements ParticleProvider<SimpleParticleType> {
		...
		public Particle createParticle(SimpleParticleType p_105910_, ClientLevel p_105911_, double p_105912_, double p_105913_, double p_105914_, double p_105915_, double p_105916_, double p_105917_) {
			CochinealTrailParticle particle = new CochinealTrailParticle(p_105911_, p_105912_, p_105913_, p_105914_, p_105915_, p_105916_, p_105917_);
