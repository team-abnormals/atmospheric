...
public class AtmosphericBlockTagsProvider extends BlockTagsProvider {
	...
	public void addTags() {
		...
		this.tag(BlockTags.SMALL_FLOWERS).add(WARM_MONKEY_BRUSH.get(), WARM_WALL_MONKEY_BRUSH.get(), HOT_MONKEY_BRUSH.get(), HOT_WALL_MONKEY_BRUSH.get(), SCALDING_MONKEY_BRUSH.get(), SCALDING_WALL_MONKEY_BRUSH.get(), YUCCA_FLOWER.get(), GILIA.get(), WATER_HYACINTH.get());
		...
		this.tag(BlockTags.OVERWORLD_NATURAL_LOGS).add(ROSEWOOD_LOG.get(), MORADO_LOG.get(), YUCCA_LOG.get(), ASPEN_LOG.get(), WATCHFUL_ASPEN_LOG.get(), KOUSA_LOG.get(), GRIMWOOD_LOG.get());
