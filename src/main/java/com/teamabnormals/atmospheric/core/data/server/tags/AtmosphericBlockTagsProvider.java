...
public class AtmosphericBlockTagsProvider extends BlockTagsProvider {
	...
	public void addTags() {
		...
		this.tag(BlockTags.SAPLINGS).add(ROSEWOOD_SAPLING.get(), MORADO_SAPLING.get(), YUCCA_SAPLING.get(), KOUSA_SAPLING.get(), ASPEN_SAPLING.get(), GRIMWOOD_SAPLING.get(), LAUREL_SAPLING.get(), DRY_LAUREL_SAPLING.get());
		...
		this.tag(BlockTags.OVERWORLD_CARVER_REPLACEABLES).add(ARID_SANDSTONE.get(), RED_ARID_SANDSTONE.get(), IVORY_TRAVERTINE.get(), PEACH_TRAVERTINE.get(), PERSIMMON_TRAVERTINE.get(), SAFFRON_TRAVERTINE.get());
		...
		this.tag(BlueprintBlockTags.LEAF_PILES).add(ROSEWOOD_LEAF_PILE.get(), MORADO_LEAF_PILE.get(), FLOWERING_MORADO_LEAF_PILE.get(), YUCCA_LEAF_PILE.get(), KOUSA_LEAF_PILE.get(), ASPEN_LEAF_PILE.get(), GRIMWOOD_LEAF_PILE.get(), LAUREL_LEAF_PILE.get(), DRY_LAUREL_LEAF_PILE.get());
		...
		this.tag(BlueprintBlockTags.HEDGES).add(ROSEWOOD_HEDGE.get(), MORADO_HEDGE.get(), FLOWERING_MORADO_HEDGE.get(), YUCCA_HEDGE.get(), KOUSA_HEDGE.get(), ASPEN_HEDGE.get(), GRIMWOOD_HEDGE.get(), LAUREL_HEDGE.get(), DRY_LAUREL_HEDGE.get());
	}
}