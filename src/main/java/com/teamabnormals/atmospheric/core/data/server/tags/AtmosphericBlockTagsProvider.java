...
public class AtmosphericBlockTagsProvider extends BlockTagsProvider {
	...
	public void addTags(Provider provider) {
		...
		this.tag(BlockTags.MINEABLE_WITH_PICKAXE).add(
				...
				DOLERITE.get(), DOLERITE_SLAB.get(), DOLERITE_STAIRS.get(), DOLERITE_WALL.get(), POLISHED_DOLERITE.get(), POLISHED_DOLERITE_SLAB.get(), POLISHED_DOLERITE_STAIRS.get(),
		...
		this.tag(BlockTags.INSIDE_STEP_SOUND_BLOCKS).add(GOLDEN_GROWTHS.get(), ARID_SPROUTS.get(), WATER_HYACINTH.get());
		...
		this.tag(BlockTags.WALLS).add(ARID_SANDSTONE_WALL.get(), RED_ARID_SANDSTONE_WALL.get(), IVORY_TRAVERTINE_WALL.get(), PEACH_TRAVERTINE_WALL.get(), PERSIMMON_TRAVERTINE_WALL.get(), SAFFRON_TRAVERTINE_WALL.get(), DOLERITE_WALL.get(), CARMINE_SHINGLE_WALL.get(), CARMINE_PAVEMENT_WALL.get());
