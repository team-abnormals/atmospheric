...
public class AtmosphericBlockTagsProvider extends BlockTagsProvider {
	...
	public void addTags() {
		this.tag(BlockTags.MINEABLE_WITH_AXE).add(
				...
				ASPEN_BOARDS.get(), ASPEN_BOOKSHELF.get(), ASPEN_LADDER.get(), ASPEN_BEEHIVE.get(), ASPEN_CHESTS.getFirst().get(), ASPEN_CHESTS.getSecond().get(), ASPEN_HEDGE.get(), GREEN_ASPEN_HEDGE.get(), ASPEN_POST.get(), STRIPPED_ASPEN_POST.get(),
				...
				ARID_SPROUTS.get(), YUCCA_BRANCH.get(), ALOE_VERA.get(), TALL_ALOE_VERA.get(), AGAVE.get(), GOLDEN_GROWTHS.get(), BRACKEN.get(),
		...
		this.tag(BlockTags.MINEABLE_WITH_HOE).add(
				...
				GREEN_ASPEN_LEAVES.get(), GREEN_ASPEN_LEAF_PILE.get(), GREEN_ASPEN_LEAF_CARPET.get(),
		...
		this.tag(BlockTags.MINEABLE_WITH_PICKAXE).add(
				...
				DOLERITE.get(), DOLERITE_SLAB.get(), DOLERITE_STAIRS.get(), DOLERITE_VERTICAL_SLAB.get(), DOLERITE_WALL.get(), POLISHED_DOLERITE.get(), POLISHED_DOLERITE_SLAB.get(), POLISHED_DOLERITE_STAIRS.get(), POLISHED_DOLERITE_VERTICAL_SLAB.get(),
				ARID_SANDSTONE.get(), ARID_SANDSTONE_SLAB.get(), ARID_SANDSTONE_STAIRS.get(), ARID_SANDSTONE_WALL.get(), ARID_SANDSTONE_VERTICAL_SLAB.get(), SMOOTH_ARID_SANDSTONE.get(), SMOOTH_ARID_SANDSTONE_SLAB.get(), SMOOTH_ARID_SANDSTONE_STAIRS.get(), SMOOTH_ARID_SANDSTONE_VERTICAL_SLAB.get(), CUT_ARID_SANDSTONE.get(), CUT_ARID_SANDSTONE_SLAB.get(), CUT_ARID_SANDSTONE_VERTICAL_SLAB.get(), CHISELED_ARID_SANDSTONE.get(), ARID_SANDSTONE_BRICKS.get(), ARID_SANDSTONE_BRICK_SLAB.get(), ARID_SANDSTONE_BRICK_STAIRS.get(), ARID_SANDSTONE_BRICK_WALL.get(), ARID_SANDSTONE_BRICK_VERTICAL_SLAB.get(),
				RED_ARID_SANDSTONE.get(), RED_ARID_SANDSTONE_SLAB.get(), RED_ARID_SANDSTONE_STAIRS.get(), RED_ARID_SANDSTONE_WALL.get(), RED_ARID_SANDSTONE_VERTICAL_SLAB.get(), SMOOTH_RED_ARID_SANDSTONE.get(), SMOOTH_RED_ARID_SANDSTONE_SLAB.get(), SMOOTH_RED_ARID_SANDSTONE_STAIRS.get(), SMOOTH_RED_ARID_SANDSTONE_VERTICAL_SLAB.get(), CUT_RED_ARID_SANDSTONE.get(), CUT_RED_ARID_SANDSTONE_SLAB.get(), CUT_RED_ARID_SANDSTONE_VERTICAL_SLAB.get(), CHISELED_RED_ARID_SANDSTONE.get(), RED_ARID_SANDSTONE_BRICKS.get(), RED_ARID_SANDSTONE_BRICK_SLAB.get(), RED_ARID_SANDSTONE_BRICK_STAIRS.get(), RED_ARID_SANDSTONE_BRICK_WALL.get(), RED_ARID_SANDSTONE_BRICK_VERTICAL_SLAB.get(),
				CARMINE_BLOCK.get(), CARMINE_SHINGLES.get(), CARMINE_SHINGLE_SLAB.get(), CARMINE_SHINGLE_STAIRS.get(), CARMINE_SHINGLE_WALL.get(), CARMINE_SHINGLE_VERTICAL_SLAB.get(), CHISELED_CARMINE_SHINGLES.get(), CARMINE_PAVEMENT.get(), CARMINE_PAVEMENT_SLAB.get(), CARMINE_PAVEMENT_STAIRS.get(), CARMINE_PAVEMENT_WALL.get(), CARMINE_PAVEMENT_VERTICAL_SLAB.get()
		);
		...
		this.tag(BlockTags.FLOWER_POTS).add(POTTED_ROSEWOOD_SAPLING.get(), POTTED_MORADO_SAPLING.get(), POTTED_YUCCA_SAPLING.get(), POTTED_KOUSA_SAPLING.get(), POTTED_ASPEN_SAPLING.get(), POTTED_GREEN_ASPEN_SAPLING.get(), POTTED_GRIMWOOD_SAPLING.get(), POTTED_LAUREL_SAPLING.get(), POTTED_DRY_LAUREL_SAPLING.get(), POTTED_WARM_MONKEY_BRUSH.get(), POTTED_HOT_MONKEY_BRUSH.get(), POTTED_SCALDING_MONKEY_BRUSH.get(), POTTED_WATER_HYACINTH.get(), POTTED_YUCCA_FLOWER.get(), POTTED_BARREL_CACTUS.get(), POTTED_GILIA.get(), POTTED_CURRANT_SEEDLING.get(), POTTED_SNOWY_CACTUS.get(), POTTED_SNOWY_BARREL_CACTUS.get(), POTTED_SNOWY_BAMBOO.get(), POTTED_AGAVE.get(), POTTED_GOLDEN_GROWTHS.get(), POTTED_FIRETHORN.get(), POTTED_FORSYTHIA.get(), POTTED_BRACKEN.get());
		this.tag(BlockTags.FLOWERS).add(FLOWERING_MORADO_LEAVES.get());
		this.tag(BlockTags.GUARDED_BY_PIGLINS).add(SHIMMERING_PASSION_FRUIT_CRATE.get(), ROSEWOOD_CHESTS.getFirst().get(), ROSEWOOD_CHESTS.getSecond().get(), MORADO_CHESTS.getFirst().get(), MORADO_CHESTS.getSecond().get(), YUCCA_CHESTS.getFirst().get(), YUCCA_CHESTS.getSecond().get(), KOUSA_CHESTS.getFirst().get(), KOUSA_CHESTS.getSecond().get(), ASPEN_CHESTS.getFirst().get(), ASPEN_CHESTS.getSecond().get(), GRIMWOOD_CHESTS.getFirst().get(), GRIMWOOD_CHESTS.getSecond().get(), LAUREL_CHESTS.getFirst().get(), LAUREL_CHESTS.getSecond().get());
		this.tag(BlockTags.LEAVES).add(ROSEWOOD_LEAVES.get(), MORADO_LEAVES.get(), FLOWERING_MORADO_LEAVES.get(), YUCCA_LEAVES.get(), KOUSA_LEAVES.get(), ASPEN_LEAVES.get(), GREEN_ASPEN_LEAVES.get(), GRIMWOOD_LEAVES.get(), LAUREL_LEAVES.get(), DRY_LAUREL_LEAVES.get());
		...
		this.tag(BlockTags.PLANKS).add(ROSEWOOD_PLANKS.get(), MORADO_PLANKS.get(), YUCCA_PLANKS.get(), KOUSA_PLANKS.get(), ASPEN_PLANKS.get(), GRIMWOOD_PLANKS.get(), LAUREL_PLANKS.get(), VERTICAL_ROSEWOOD_PLANKS.get(), VERTICAL_MORADO_PLANKS.get(), VERTICAL_YUCCA_PLANKS.get(), VERTICAL_KOUSA_PLANKS.get(), VERTICAL_ASPEN_PLANKS.get(), VERTICAL_GRIMWOOD_PLANKS.get(), VERTICAL_LAUREL_PLANKS.get());
		...
		this.tag(BlockTags.SMALL_FLOWERS).add(WARM_MONKEY_BRUSH.get(), HOT_MONKEY_BRUSH.get(), SCALDING_MONKEY_BRUSH.get(), YUCCA_FLOWER.get(), GILIA.get(), WATER_HYACINTH.get(), FIRETHORN.get(), FORSYTHIA.get());
		...
		this.tag(BlockTags.REPLACEABLE_PLANTS).add(AGAVE.get(), GOLDEN_GROWTHS.get(), ARID_SPROUTS.get(), BRACKEN.get());
		...
		this.tag(BlockTags.STAIRS).add(ARID_SANDSTONE_STAIRS.get(), SMOOTH_ARID_SANDSTONE_STAIRS.get(), ARID_SANDSTONE_BRICK_STAIRS.get(), RED_ARID_SANDSTONE_STAIRS.get(), SMOOTH_RED_ARID_SANDSTONE_STAIRS.get(), RED_ARID_SANDSTONE_BRICK_STAIRS.get(), IVORY_TRAVERTINE_STAIRS.get(), PEACH_TRAVERTINE_STAIRS.get(), PERSIMMON_TRAVERTINE_STAIRS.get(), SAFFRON_TRAVERTINE_STAIRS.get(), DOLERITE_STAIRS.get(), POLISHED_DOLERITE_STAIRS.get(), CARMINE_SHINGLE_STAIRS.get(), CARMINE_PAVEMENT_STAIRS.get());
		this.tag(BlockTags.WALLS).add(ARID_SANDSTONE_WALL.get(), ARID_SANDSTONE_BRICK_WALL.get(), RED_ARID_SANDSTONE_WALL.get(), RED_ARID_SANDSTONE_BRICK_WALL.get(), IVORY_TRAVERTINE_WALL.get(), PEACH_TRAVERTINE_WALL.get(), PERSIMMON_TRAVERTINE_WALL.get(), SAFFRON_TRAVERTINE_WALL.get(), DOLERITE_WALL.get(), CARMINE_SHINGLE_WALL.get(), CARMINE_PAVEMENT_WALL.get());
		...
		this.tag(Tags.Blocks.FENCES_WOODEN).add(ROSEWOOD_FENCE.get(), MORADO_FENCE.get(), YUCCA_FENCE.get(), KOUSA_FENCE.get(), ASPEN_FENCE.get(), GRIMWOOD_FENCE.get(), LAUREL_FENCE.get());
		...
		this.tag(BlueprintBlockTags.LADDERS).add(ROSEWOOD_LADDER.get(), MORADO_LADDER.get(), YUCCA_LADDER.get(), KOUSA_LADDER.get(), ASPEN_LADDER.get(), GRIMWOOD_LADDER.get(), LAUREL_LADDER.get());
		this.tag(BlueprintBlockTags.VERTICAL_SLABS).add(ARID_SANDSTONE_VERTICAL_SLAB.get(), SMOOTH_ARID_SANDSTONE_VERTICAL_SLAB.get(), CUT_ARID_SANDSTONE_VERTICAL_SLAB.get(), ARID_SANDSTONE_BRICK_VERTICAL_SLAB.get(), RED_ARID_SANDSTONE_VERTICAL_SLAB.get(), SMOOTH_RED_ARID_SANDSTONE_VERTICAL_SLAB.get(), CUT_RED_ARID_SANDSTONE_VERTICAL_SLAB.get(), RED_ARID_SANDSTONE_BRICK_VERTICAL_SLAB.get(), IVORY_TRAVERTINE_VERTICAL_SLAB.get(), PEACH_TRAVERTINE_VERTICAL_SLAB.get(), PERSIMMON_TRAVERTINE_VERTICAL_SLAB.get(), SAFFRON_TRAVERTINE_VERTICAL_SLAB.get(), DOLERITE_VERTICAL_SLAB.get(), POLISHED_DOLERITE_VERTICAL_SLAB.get(), CARMINE_SHINGLE_VERTICAL_SLAB.get(), CARMINE_PAVEMENT_VERTICAL_SLAB.get());
		this.tag(BlueprintBlockTags.WOODEN_VERTICAL_SLABS).add(ROSEWOOD_VERTICAL_SLAB.get(), MORADO_VERTICAL_SLAB.get(), YUCCA_VERTICAL_SLAB.get(), KOUSA_VERTICAL_SLAB.get(), ASPEN_VERTICAL_SLAB.get(), GRIMWOOD_VERTICAL_SLAB.get(), LAUREL_VERTICAL_SLAB.get());
		this.tag(BlueprintBlockTags.HEDGES).add(ROSEWOOD_HEDGE.get(), MORADO_HEDGE.get(), FLOWERING_MORADO_HEDGE.get(), YUCCA_HEDGE.get(), KOUSA_HEDGE.get(), ASPEN_HEDGE.get(), GRIMWOOD_HEDGE.get(), LAUREL_HEDGE.get(), DRY_LAUREL_HEDGE.get(), CURRANT_HEDGE.get());
	}
}