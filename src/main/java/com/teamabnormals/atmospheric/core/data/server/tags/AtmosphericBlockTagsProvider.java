...
public class AtmosphericBlockTagsProvider extends BlockTagsProvider {
	...
	public void addTags() {
		this.tag(BlockTags.MINEABLE_WITH_AXE).add(
				...
				SNOWY_BAMBOO.get(), HANGING_CURRANT.get(), CURRANT_STALK.get(), CURRANT_STALK_BUNDLE.get(), CURRANT_CRATE.get(), CURRANT_HEDGE.get(),
		...
		this.tag(BlockTags.GUARDED_BY_PIGLINS).add(SHIMMERING_PASSION_FRUIT_CRATE.get(), GOLDEN_DRAGON_FRUIT_CRATE.get(), ROSEWOOD_CHESTS.getFirst().get(), ROSEWOOD_CHESTS.getSecond().get(), MORADO_CHESTS.getFirst().get(), MORADO_CHESTS.getSecond().get(), YUCCA_CHESTS.getFirst().get(), YUCCA_CHESTS.getSecond().get(), KOUSA_CHESTS.getFirst().get(), KOUSA_CHESTS.getSecond().get(), ASPEN_CHESTS.getFirst().get(), ASPEN_CHESTS.getSecond().get(), GRIMWOOD_CHESTS.getFirst().get(), GRIMWOOD_CHESTS.getSecond().get(), LAUREL_CHESTS.getFirst().get(), LAUREL_CHESTS.getSecond().get());
		...
		this.tag(COCHINEALS_CAN_SUCKLE).add(Blocks.CACTUS, SNOWY_CACTUS.get());
