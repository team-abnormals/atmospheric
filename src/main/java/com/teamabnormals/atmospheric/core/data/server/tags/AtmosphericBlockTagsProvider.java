...
public class AtmosphericBlockTagsProvider extends BlockTagsProvider {
	...
	public void addTags() {
		...
		this.tag(BlockTags.FLOWER_POTS).add(POTTED_ROSEWOOD_SAPLING.get(), POTTED_MORADO_SAPLING.get(), POTTED_YUCCA_SAPLING.get(), POTTED_KOUSA_SAPLING.get(), POTTED_ASPEN_SAPLING.get(), POTTED_GRIMWOOD_SAPLING.get(), POTTED_LAUREL_SAPLING.get(), POTTED_DRY_LAUREL_SAPLING.get(), POTTED_WARM_MONKEY_BRUSH.get(), POTTED_HOT_MONKEY_BRUSH.get(), POTTED_SCALDING_MONKEY_BRUSH.get(), POTTED_WATER_HYACINTH.get(), POTTED_YUCCA_FLOWER.get(), POTTED_BARREL_CACTUS.get(), POTTED_GILIA.get(), POTTED_CURRANT_SEEDLING.get(), POTTED_SNOWY_BAMBOO.get(), POTTED_AGAVE.get(), POTTED_GOLDEN_GROWTHS.get(), POTTED_FIRETHORN.get(), POTTED_FORSYTHIA.get());
