...
public class AtmosphericProperties {
	...
	public static final Block.Properties STEMMED_ORANGE = Block.Properties.of(Material.PLANT, MaterialColor.COLOR_ORANGE).strength(0F).sound(SoundType.HONEY_BLOCK);
}
