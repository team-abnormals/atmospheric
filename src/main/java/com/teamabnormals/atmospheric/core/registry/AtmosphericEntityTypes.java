...
public class AtmosphericEntityTypes {
	...
	public static final RegistryObject<EntityType<Tetra>> TETRA = HELPER.createEntity("tetra", Tetra::new, Tetra::new, MobCategory.WATER_AMBIENT, 0.3F, 0.2F);
	...
	public static void registerSpawnPlacements(SpawnPlacementRegisterEvent event) {
		event.register(TETRA.get(), SpawnPlacements.Type.IN_WATER, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, Tetra::checkTetraSpawnRules, Operation.AND);
