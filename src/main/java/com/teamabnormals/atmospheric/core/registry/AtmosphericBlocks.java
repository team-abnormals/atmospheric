...
public class AtmosphericBlocks {
	...
	public static final RegistryObject<Block> PASSION_VINE = HELPER.createBlock("passion_vine", () -> new PassionVineBlock(Block.Properties.of(Material.PLANT).noCollission().randomTicks().instabreak().sound(SoundType.VINE)), CreativeModeTab.TAB_DECORATIONS);
	...
	public static final RegistryObject<Block> WATER_HYACINTH = HELPER.createBlockNoItem("water_hyacinth", () -> new WaterHyacinthBlock(Block.Properties.of(Material.PLANT).noCollission().instabreak().sound(SoundType.VINE)));
	...
	public static final RegistryObject<Block> WARM_WALL_MONKEY_BRUSH = HELPER.createWallOrVerticalBlock("warm_monkey_brush", "warm_wall_monkey_brush", WARM_MONKEY_BRUSH, () -> new WallMonkeyBrushBlock(PropertyUtil.flower().offsetType(OffsetType.NONE).lootFrom(WARM_MONKEY_BRUSH)), CreativeModeTab.TAB_DECORATIONS);
	public static final RegistryObject<Block> HOT_WALL_MONKEY_BRUSH = HELPER.createWallOrVerticalBlock("hot_monkey_brush", "hot_wall_monkey_brush", HOT_MONKEY_BRUSH, () -> new WallMonkeyBrushBlock(PropertyUtil.flower().offsetType(OffsetType.NONE).lootFrom(HOT_MONKEY_BRUSH)), CreativeModeTab.TAB_DECORATIONS);
	public static final RegistryObject<Block> SCALDING_WALL_MONKEY_BRUSH = HELPER.createWallOrVerticalBlock("scalding_monkey_brush", "scalding_wall_monkey_brush", SCALDING_MONKEY_BRUSH, () -> new WallMonkeyBrushBlock(PropertyUtil.flower().offsetType(OffsetType.NONE).lootFrom(SCALDING_MONKEY_BRUSH)), CreativeModeTab.TAB_DECORATIONS);
	...
	public static final RegistryObject<Block> LAUREL_SAPLING = HELPER.createBlock("laurel_sapling", () -> new LaurelSaplingBlock(new LaurelTreeGrower(), AtmosphericProperties.LAUREL.sapling()), CreativeModeTab.TAB_DECORATIONS);
	...
	public static final RegistryObject<Block> DRY_LAUREL_SAPLING = HELPER.createBlock("dry_laurel_sapling", () -> new LaurelSaplingBlock(new DryLaurelTreeGrower(), AtmosphericProperties.DRY_LAUREL.sapling()), CreativeModeTab.TAB_DECORATIONS);
	...
	public static final RegistryObject<Block> BRACKEN = HELPER.createBlock("bracken", () -> new BrackenBlock(BlockBehaviour.Properties.of(Material.REPLACEABLE_PLANT).noCollission().instabreak().sound(SoundType.GRASS).offsetType(BlockBehaviour.OffsetType.XYZ)), CreativeModeTab.TAB_DECORATIONS);
	public static final RegistryObject<Block> POTTED_BRACKEN = HELPER.createBlockNoItem("potted_bracken", () -> new FlowerPotBlock(BRACKEN.get(), PropertyUtil.flowerPot()));
