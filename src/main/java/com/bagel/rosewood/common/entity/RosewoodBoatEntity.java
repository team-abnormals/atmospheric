...
public class RosewoodBoatEntity extends BoatEntity {
	...
	public RosewoodBoatEntity(World worldIn, double x, double y, double z) {
		this(RosewoodEntities.BOAT.get(), worldIn);
	...
	public RosewoodBoatEntity(FMLPlayMessages.SpawnEntity spawnEntity, World world) {
		this(RosewoodEntities.BOAT.get(), world);
	}
	...
	protected void registerData() {
		...
		this.dataManager.register(BOAT_TYPE, Type.ROSEWOOD.ordinal());
    ...
    public Item getItemBoat() {
		switch (this.getBoatModel()) {
			case ROSEWOOD:
			default:
				return RosewoodItems.ROSEWOOD_BOAT.get();
		}
	}
	...
	public enum Type {
		ROSEWOOD(com.bagel.rosewood.core.registry.RosewoodBlocks.ROSEWOOD_PLANKS.get(), "rosewood");
