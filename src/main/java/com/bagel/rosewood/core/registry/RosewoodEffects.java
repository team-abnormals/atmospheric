...
import com.bagel.rosewood.common.effects.ReliefEffect;
import com.bagel.rosewood.common.effects.WorseningEffect;
...
public class RosewoodEffects {
	public static final DeferredRegister<Effect> EFFECTS = new DeferredRegister<>(ForgeRegistries.POTIONS, Rosewood.MODID);
	public static final DeferredRegister<Potion> POTIONS = new DeferredRegister<>(ForgeRegistries.POTION_TYPES, Rosewood.MODID);
