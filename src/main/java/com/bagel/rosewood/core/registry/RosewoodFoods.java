...
public class RosewoodFoods {
	...
	public static Food PASSIONFRUIT = new Food.Builder().hunger(2).saturation(0.3F).effect(new EffectInstance(SPITTING, 140, 0, true, false), 1.0F).build();
	public static Food SHIMMERING_PASSIONFRUIT = new Food.Builder().hunger(5).saturation(1.2F).effect(new EffectInstance(GOLDEN_SPITTING, 160, 0, true, false), 1.0F).build();
