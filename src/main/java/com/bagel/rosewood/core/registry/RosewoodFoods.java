...
public class RosewoodFoods {
	...
	public static Food SHIMMERING_PASSIONFRUIT = new Food.Builder().hunger(5).saturation(1.2F).setAlwaysEdible().effect(new EffectInstance(GOLDEN_SPITTING, 160, 0, true, false), 1.0F).build();
