...
public class AridShrinePieces {
    ...
    public static class Piece extends TemplateStructurePiece {
        ...
        @Override
        public boolean func_230383_a_(ISeedReader worldIn, StructureManager p_230383_2_, ChunkGenerator p_225577_2_, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos chunkPos, BlockPos p_230383_7_) {
            PlacementSettings placementsettings = (new PlacementSettings()).setRotation(this.rotation).setMirror(Mirror.NONE);
            ...
            return super.func_230383_a_(worldIn, p_230383_2_, p_225577_2_, randomIn, structureBoundingBoxIn, chunkPos, blockpos);
        }
    }
}
