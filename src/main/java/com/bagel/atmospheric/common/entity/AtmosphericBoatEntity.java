...
public class AtmosphericBoatEntity extends Entity {
   ...
   public AtmosphericBoatEntity(EntityType<? extends AtmosphericBoatEntity> p_i50129_1_, World p_i50129_2_) {
   ...
   protected void registerData() {
      ...
      this.dataManager.register(BOAT_TYPE, AtmosphericBoatEntity.Type.ROSEWOOD.ordinal());
   ...
   protected void readAdditional(CompoundNBT compound) {
      if (compound.contains("Type", 8)) {
         this.setBoatType(AtmosphericBoatEntity.Type.getTypeFromString(compound.getString("Type")));
      }
   ...
   public AtmosphericBoatEntity.Type getBoatModel() {
      return AtmosphericBoatEntity.Type.byId(this.dataManager.get(BOAT_TYPE));
   }
   ...
   public static enum Type {
       ...
       */
      public static AtmosphericBoatEntity.Type byId(int id) {
    	  AtmosphericBoatEntity.Type[] aboatentity$type = values();
      ...
      public static AtmosphericBoatEntity.Type getTypeFromString(String nameIn) {
    	  AtmosphericBoatEntity.Type[] aboatentity$type = values();
