...
public class AtmosphericFoods {
	...
	public static Food SHIMMERING_PASSIONFRUIT = new Food.Builder().hunger(5).saturation(0.2F).setAlwaysEdible().effect(new EffectInstance(AtmosphericEffects.SPITTING, 140, 1, true, false), 1.0F).build();
