...
public class AtmosphericFoods {
	...
	public static Food PASSIONFRUIT = new Food.Builder().hunger(3).saturation(0.3F).setAlwaysEdible().effect(new EffectInstance(AtmosphericEffects.SPITTING, 140, 0, true, false), 1.0F).build();
	public static Food SHIMMERING_PASSIONFRUIT = new Food.Builder().hunger(5).saturation(0.2F).setAlwaysEdible().effect(new EffectInstance(AtmosphericEffects.GOLDEN_SPITTING, 140, 0, true, false), 1.0F).build();
	...
	public static Food ALOE_GEL = new Food.Builder().hunger(3).saturation(0.2F).setAlwaysEdible().build();
}
