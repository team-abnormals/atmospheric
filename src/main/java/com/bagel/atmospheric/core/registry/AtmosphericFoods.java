...
public class AtmosphericFoods {
	...
	public static final Food ROASTED_YUCCA_FRUIT = new Food.Builder().hunger(6).saturation(0.5F).effect(() -> new EffectInstance(AtmosphericEffects.PERSISTENCE, 560, 0), 1.0F).build();
	public static final Food YUCCA_JUICE = new Food.Builder().hunger(3).saturation(0.7F).effect(() -> new EffectInstance(AtmosphericEffects.PERSISTENCE, 1080, 0), 1.0F).build();
	
	public static final Food ALOE_LEAVES = new Food.Builder().hunger(2).saturation(0.1F).effect(() -> new EffectInstance(AtmosphericEffects.GELLED, 280, 0, false, false), 1.0F).build();
	public static final Food ALOE_GEL = new Food.Builder().hunger(3).saturation(0.2F).setAlwaysEdible().effect(() -> new EffectInstance(AtmosphericEffects.GELLED, 960, 0, false, false), 1.0F).build();
}
