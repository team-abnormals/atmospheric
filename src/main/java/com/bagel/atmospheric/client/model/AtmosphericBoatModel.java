...
@OnlyIn(Dist.CLIENT)
public class AtmosphericBoatModel extends SegmentedModel<AtmosphericBoatEntity> {
   ...
   @Override
   public void setRotationAngles(AtmosphericBoatEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
   ...
   protected void func_228244_a_(AtmosphericBoatEntity p_228244_1_, int p_228244_2_, float p_228244_3_) {
