...
public class AtmosphericCompat {
	...
	public static void registerCompostables() {
		...
		DataUtils.registerCompostable(AtmosphericBlocks.PASSION_VINE.get(), 0.3F);
		DataUtils.registerCompostable(AtmosphericItems.PASSION_VINE_COIL.get(), 0.85F);
		DataUtils.registerCompostable(AtmosphericBlocks.PASSION_VINE_BUNDLE.get(), 1.0F);
