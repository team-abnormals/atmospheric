...
public class AtmosphericFeatures {
	...
	public static final class Configured {
		...
		public static final ConfiguredFeature<?, ?> MORADO_WATER_TREE = AtmosphericFeatures.ROSEWOOD_WATER_TREE.get().withConfiguration(AtmosphericFeatures.Configs.MORADO_TREE_WITH_FEW_BEEHIVES_CONFIG).withPlacement(Features.Placements.HEIGHTMAP_PLACEMENT).withPlacement(Placement.COUNT_EXTRA.configure(new AtSurfaceWithExtraConfig(95, 0, 0)));
		public static final ConfiguredFeature<?, ?> MORADO_WATER_TREE_SPARSE = AtmosphericFeatures.ROSEWOOD_WATER_TREE.get().withConfiguration(AtmosphericFeatures.Configs.MORADO_TREE_WITH_FEW_BEEHIVES_CONFIG).withPlacement(Features.Placements.HEIGHTMAP_PLACEMENT).withPlacement(Placement.COUNT_EXTRA.configure(new AtSurfaceWithExtraConfig(5, 0, 0)));
