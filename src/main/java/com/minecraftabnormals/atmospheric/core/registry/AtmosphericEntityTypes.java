...
public class AtmosphericEntityTypes {
	...
	public static final RegistryObject<EntityType<PassionfruitSeedEntity>> PASSIONFRUIT_SEED = HELPER.createEntity("passionfruit_seed", PassionfruitSeedEntity::new, PassionfruitSeedEntity::new, MobCategory.MISC, 0.25F, 0.25F);
}
