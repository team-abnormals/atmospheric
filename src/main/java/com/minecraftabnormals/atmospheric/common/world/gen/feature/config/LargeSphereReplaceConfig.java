...
public class LargeSphereReplaceConfig implements IFeatureConfig {
	public static final Codec<LargeSphereReplaceConfig> field_236516_a_ = RecordCodecBuilder.create((p_236518_0_) -> {
		return p_236518_0_.group(BlockState.CODEC.fieldOf("state").forGetter((p_236521_0_) -> {
			return p_236521_0_.state;
		}), FeatureSpread.func_242254_a(0, Integer.MAX_VALUE, 4).fieldOf("radius").forGetter((p_236520_0_) -> {
