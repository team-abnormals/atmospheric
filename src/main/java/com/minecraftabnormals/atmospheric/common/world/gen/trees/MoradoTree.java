...
public class MoradoTree extends AbstractTreeGrower {

	@Nullable
	protected ConfiguredFeature<TreeConfiguration, ?> getConfiguredFeature(Random randomIn, boolean beehive) {
		return AtmosphericFeatures.ROSEWOOD_TREE.get().configured(beehive ? AtmosphericFeatures.Configs.MORADO_TREE_WITH_MORE_BEEHIVES_CONFIG : AtmosphericFeatures.Configs.MORADO_TREE_CONFIG);
	}
}
